...
From the engine room team, on this project [Danna Ingleton](https://www.theengineroom.org/our_team/danna-ingleton/), Responsible Data Program Manager, was involved in project conception and set up. [Zara Rahman](https://www.theengineroom.org/our_team/zara-rahman/) managed the project and came up with the idea of topic-specific microsites like the one you see here. [Tom Walker](https://www.theengineroom.org/our_team/tom-walker/) carried out the research, including all interviews and the write up of the bulk of the content. [Maya Richman](https://www.theengineroom.org/our_team/maya-richman/) contributed the tools functionalities table, and [Tin Geber](https://www.theengineroom.org/our_team/tin-geber/) and [Alix Dunn](https://www.theengineroom.org/our_team/alix-dunn/) provided useful feedback and guidance to the design.
